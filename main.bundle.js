...
var content = {
  ...
  p1: 'I\'m a visual designer who loves creating consistent, eye-catching and pixel perfect layouts.',
  p2: 'I also enjoy making ilustrations and taking photographs.',
  p3: 'You can find me here:<br>' + //    '<a href=\'mailto:mflorenciaantacle@gmail.com\'>Email</a>, '+
  '<a href=\'https://www.behance.net/antacle\' target=\'_blank\'>Behance</a>, ' + '<a href=\'https://dribbble.com/antacle\' target=\'_blank\'>Dribbble</a>, ' + '<a href=\'https://www.instagram.com/florenciaantacle\' target=\'_blank\'>Instagram</a> & ' + '<a href=\'https://github.com/mfantacle\' target=\'_blank\'>GitHub</a>.'
};
var appContent = '<div class="content">' + '<div class="card">' + '<h1>' + content.title + '</h1>' + '<h2>' + content.subtitle + '</h2>' + '<p>' + content.p1 + '</p>' + '<p>' + content.p2 + '</p>' + '<p>' + content.p3 + '</p>' + '</div>' + '</div>';
